...
/**
* Returns map options button onClick handler, active button state, and container visibility
**/
...
/**
* Returns filter button and icon props
**/
...
/**
* Returns map option button and icon props
**/
